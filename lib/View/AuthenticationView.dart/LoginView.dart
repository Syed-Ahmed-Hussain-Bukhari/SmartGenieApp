...
import 'package:my_smart_genie/View/AuthenticationView.dart/ForgotPassword.dart';
import 'package:my_smart_genie/View/AuthenticationView.dart/SignUpView.dart';
...
import 'package:my_smart_genie/controller/LoginViewController.dart';
  ...
  () => Container(
    ...
    child: TextFormField(
      ...
      decoration: InputDecoration(
        ...
        // contentPadding: EdgeInsets.only(top: 40,left: 8),
        ...
        focusedErrorBorder: OutlineInputBorder(
          ...
          borderSide: BorderSide(color: MyColors.mainColor, width: 2.0),
                ...
                constant.mySizedBox(context, 0, 0.01),
                Container(
                  margin: EdgeInsets.only(right: MediaQuery.sizeOf(context).width * 0.1),
                  child: Row(
                  ...
                  child: InkWell(
                    onTap: () {
                      if (_formKey.currentState!.validate()) {
                        _LoginViewController.loginUser(
                          context,
                ...
                Row(
                  ...
                  children: [
                    myText(context, "Don't have an account?", MyColors.userTextColor, 16, 0.04, 0.035),
                    InkWell(
                      onTap: () {
                        Get.to(SignUpView());
                      },
