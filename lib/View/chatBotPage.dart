...
import 'package:my_smart_genie/View/drawer.dart';
import 'package:my_smart_genie/View/imageViewer.dart';
import 'package:my_smart_genie/controller/logoutController.dart';
import 'package:my_smart_genie/controller/themeController.dart';
...
//       if (imageMessage is Uint8List) {
//         // Handle Uint8List image data
//         final result = await ImageGallerySaverPlus.saveImage(imageMessage);
...
void _imageDownload() async {
  try {
    ...
    if (imageMessage != null) {
      ...
      if (imageMessage is Uint8List) {
        await FlutterImageGallerySaver.saveImage(imageMessage);
        isSuccess = true;
      } else if (imageMessage is File) {
        final Uint8List imageData = await imageMessage.readAsBytes();
        await FlutterImageGallerySaver.saveImage(imageData);
        isSuccess = true;
      } else if (imageMessage is String) {
        final RegExp regExp = RegExp(r"File: '(.+)'");
        final match = regExp.firstMatch(imageMessage);
        ...
        actions: selectedMessageIndex != null?  
             ...
             [
                ...
                IconButton(
                  ...
                  // },
                  onPressed: _shareMessage,
                  icon: Icon(Icons.share,color: MyColors.whiteColor)), 
              ]:[
               Expanded(
                 child: Row(
                  ...
                  children: [
                    IconButton(
                    icon: Icon(Icons.copy,color: MyColors.whiteColor),
                 ...
                 _shareMessage,
                  ...
                  _isSpeaking?IconButton(
                      icon: Icon(Icons.volume_up,color: MyColors.whiteColor),
                      onPressed: () {
                          _stopSpeaking();  
                      },
                    ):IconButton(
                      icon: Icon(Icons.volume_off,color: MyColors.whiteColor),
                      onPressed: () {
                          _speak();  
                      },
                    ),                
                ...
                children: [
                    ...
                    InkWell(
                      ...
                      color: MyColors.userTextbgColor
                                     ...
                                     child:Text(
  (textForPromptSuggestion1 == null || textForPromptSuggestion1.trim().isEmpty)
      ? "Current events like Pakistan India war"
      : textForPromptSuggestion3,
  style: TextStyle(
    fontSize: 14,
    ...
    fontWeight: FontWeight.w600,
                    ...
                    InkWell(
                      ...
                      color: MyColors.userTextbgColor
                        ...
                        child: Text(
  (textForPromptSuggestion2 == null || textForPromptSuggestion2.trim().isEmpty)
      ? "Current events like Pakistan India war"
      : textForPromptSuggestion3,
  style: TextStyle(
    fontSize: 14,
    ...
    fontWeight: FontWeight.w600,
                    ...
                    InkWell(
                      ...
                      color: MyColors.userTextbgColor
                        ...
                        child: Text(
  (textForPromptSuggestion3 == null || textForPromptSuggestion3.trim().isEmpty)
      ? "Current events like Pakistan India war"
      : textForPromptSuggestion3,
  style: TextStyle(
    fontSize: 14,
